...
//fun Flows._init_values() {
    ...
    _environment_route_point(191, 127, 22);
    _environment_route_point(197, 142, 29);
    ...
    _environment_route(false);
    _environment_route_point(315, 30, 17);
    _environment_route_point(297, 27, 41);
    _environment_route_point(230, 28, 54);
    _environment_route_point(184, 46, 30);
    _environment_route_point(177, 77, 41);
    ...
    _flowPoint(79, 161, 37, 174);
    _flowPoint(76, 156, 39, 161);
    _flowPoint(55, 172, 49, -128);
    _flowPoint(186, 126, 33, 88);
    _flowPoint(279, 88, 17, -87);
    _flowPoint(285, 84, 29, -90);
    _flowPoint(327, 78, 26, -121);
    _flowPoint(303, 77, 24, -111);
    _flowPoint(349, 81, 17, -97);
    _flowPoint(344, 71, 25, -132);
    _flowPoint(259, 78, 45, 180);
    _flowPoint(262, 97, 28, 180);
    _flowPoint(241, 117, 77, 173);
    _flowPoint(255, 140, 57, -178);
    _flowPoint(228, 134, 19, 180);
    _flowPoint(135, 164, 33, -153);
