...
//fun Flows._init_values() {
    ...
    _environment_route(false);
    _environment_route_point(20, 175, 47);
    _environment_route_point(23, 206, 17);
    _environment_route_point(29, 238, 16);
    _environment_route_point(70, 246, 35);
    _environment_route_point(155, 218, 18);
    _environment_route_point(200, 207, 28);
    _environment_route_point(264, 231, 15);
    _environment_route_point(323, 241, 12);
    _environment_route_point(338, 209, 8);
    _environment_route_point(342, 179, 5);
    _environment_route_point(345, 150, 7);
    _environment_route_point(341, 115, 8);
    _environment_route_point(324, 95, 8);
    _environment_route_point(291, 87, 21);
    _environment_route_point(263, 106, 27);
    _environment_route_point(213, 114, 41);
    _environment_route_point(157, 121, 30);
    _environment_route_point(105, 120, 20);
    _environment_route_point(98, 92, 21);
    _environment_route_point(80, 66, 7);
    _environment_route_point(55, 58, 34);
    _environment_route_point(33, 72, 31);
    _environment_route_point(20, 98, 17);
    _environment_route_point(18, 140, 14);
    _environment_route_point(18, 161, 15);
    ...
    _flowPoint(299, 128, 34, -80);
    _flowPoint(300, 114, 21, -65);
    _flowPoint(308, 123, 20, -43);
    _flowPoint(288, 123, 22, -153);
    _flowPoint(312, 136, 38, 6);
    _flowPoint(208, 81, 20, 90);
    _flowPoint(219, 77, 25, 79);
    _flowPoint(198, 80, 28, 119);
    ...
    _environment_route(false);
    _environment_route_point(249, 47, 16);
    _environment_route_point(272, 58, 24);
    _environment_route_point(293, 83, 20);
    _environment_route_point(262, 103, 20);
    _environment_route_point(240, 113, 32);
    _environment_route_point(226, 135, 13);
    _environment_route_point(222, 150, 22);
    _environment_route_point(216, 178, 20);
    _environment_route_point(216, 193, 12);
    _environment_route_point(215, 212, 17);
    _environment_route_point(210, 229, 20);
    _environment_route_point(190, 234, 23);
    _environment_route_point(169, 227, 19);
    _environment_route_point(155, 223, 11);
    _environment_route_point(141, 214, 6);
    _environment_route_point(125, 202, 14);
    _environment_route_point(99, 189, 18);
    _environment_route_point(75, 190, 29);
    _environment_route_point(45, 194, 18);
    _environment_route_point(26, 204, 18);
    _environment_route_point(16, 217, 17);
    _environment_route_point(10, 235, 27);

    _environment_route(false);
    _environment_route_point(73, 47, 28);
    _environment_route_point(62, 107, 21);
    _environment_route_point(45, 142, 23);
    _environment_route_point(34, 175, 23);

    _flowPoint(101, 221, 33, -39);
    _flowPoint(128, 233, 25, -67);
    _flowPoint(140, 238, 27, -49);
    _flowPoint(137, 182, 35, 135);
    _flowPoint(171, 202, 30, 124);
    _flowPoint(162, 197, 25, 162);
    _flowPoint(189, 142, 40, 28);
    _flowPoint(192, 142, 24, 2);
    _flowPoint(191, 155, 12, 55);
    _flowPoint(178, 182, 41, 49);
    _flowPoint(138, 168, 32, -137);
    _flowPoint(129, 252, 30, 27);
    _flowPoint(92, 256, 49, 180);
    _flowPoint(96, 242, 28, -172);
    _flowPoint(37, 264, 14, 180);
    _flowPoint(40, 249, 17, -167);
    _flowPoint(41, 241, 14, -168);
    _flowPoint(48, 230, 23, -95);
    _flowPoint(64, 226, 36, -90);
    _flowPoint(57, 160, 39, 81);
    _flowPoint(14, 177, 32, 90);
    _flowPoint(263, 148, 36, -163);
    _flowPoint(256, 161, 44, -164);
    _flowPoint(262, 173, 18, 148);
    _flowPoint(206, 192, 40, 23);
    _flowPoint(218, 208, 15, 90);
    _flowPoint(198, 214, 10, 163);
    _flowPoint(178, 117, 27, -26);
    _flowPoint(164, 123, 32, 176);
    _flowPoint(195, 121, 31, 0);
    _flowPoint(173, 122, 25, -90);
    _flowPoint(155, 252, 34, -63);
    _flowPoint(157, 237, 21, -34);
    _flowPoint(183, 252, 18, -99);
    _flowPoint(180, 248, 21, -93);
    _flowPoint(227, 255, 24, -140);
    _flowPoint(206, 261, 24, -90);
    _flowPoint(201, 258, 29, -63);
    _flowPoint(220, 254, 12, -108);
    _flowPoint(252, 239, 42, -176);
    _flowPoint(235, 229, 22, 180);
...
bool isBlackRight() {
    return (((CSRight_R > 29 - 10) && (CSRight_R < 49 + 10)) && ((CSRight_G > 29 - 10) && (CSRight_G < 49 + 10)) &&
            ((CSRight_B > 29 - 10) && (CSRight_B < 49 + 10)));
}

bool isBlackLeft() {
    return (((CSLeft_R > 29 - 10) && (CSLeft_R < 49 + 10)) && ((CSLeft_G > 29 - 10) && (CSLeft_G < 49 + 10)) &&
            ((CSLeft_B > 29 - 10) && (CSLeft_B < 49 + 10)));
}
...
bool isBlueRight() {
    return (((CSRight_R > 29 - 10) && (CSRight_R < 60 + 10)) && ((CSRight_G > 249 - 10) && (CSRight_G < 255 + 10)) &&
            ((CSRight_B > 255 - 10) && (CSRight_B < 255 + 10)));
}

bool isBlueLeft() {
    return (((CSLeft_R > 29 - 10) && (CSLeft_R < 60 + 10)) && ((CSLeft_G > 249 - 10) && (CSLeft_G < 255 + 10)) &&
            ((CSLeft_B > 255 - 10) && (CSLeft_B < 255 + 10)));
}
...
############################
  */
  ...
  else if(CSLeft_R>=200 && CSLeft_R<=250 && CSLeft_G>=115 && CSLeft_G<=180 && CSLeft_B>=0 && CSLeft_B<=15 && CSRight_R>=200 && CSRight_R<=250 && CSRight_G>=115 && CSRight_G<=180 && CSRight_B>=0 && CSRight_B<=15&&(LoadedObjects>0))
  {
      Duration = 49;
      CurAction =2;
  }
  else if(CSLeft_R>=200 && CSLeft_R<=250 && CSLeft_G>=115 && CSLeft_G<=180 && CSLeft_B>=0 && CSLeft_B<=15&&(LoadedObjects>0))
  {
      Duration = 0;
      CurAction =3;
  }
  else if(CSRight_R>=200 && CSRight_R<=250 && CSRight_G>=115 && CSRight_G<=180 && CSRight_B>=0 && CSRight_B<=15&&(LoadedObjects>0))
  {
      Duration = 0;
      CurAction =4;
  }
  else if(US_Front>=0 && US_Front<=12 && CSLeft_R>=195 && CSLeft_R<=255 && CSLeft_G>=195 && CSLeft_G<=255 && CSLeft_B>=0 && CSLeft_B<=10 && CSRight_R>=195 && CSRight_R<=255 && CSRight_G>=195 && CSRight_G<=255 && CSRight_B>=0 && CSRight_B<=10)
  {
      Duration = 0;
      CurAction =5;
  }
  ...
  else if(CSLeft_R>=195 && CSLeft_R<=255 && CSLeft_G>=195 && CSLeft_G<=255 && CSLeft_B>=0 && CSLeft_B<=10)
  {
      Duration = 0;
      CurAction =7;
  }
  else if(CSRight_R>=195 && CSRight_R<=255 && CSRight_G>=195 && CSRight_G<=255 && CSRight_B>=0 && CSRight_B<=10)
  {
      Duration = 0;
      CurAction =8;
  }
  else if(CSLeft_R>=220 && CSLeft_R<=255 && CSLeft_G>=20 && CSLeft_G<=55 && CSLeft_B>=20 && CSLeft_B<=55&&(LoadedObjects<6))
  {
      Duration = 49;
      CurAction =9;
  }
  else if(CSRight_R>=220 && CSRight_R<=255 && CSRight_G>=20 && CSRight_G<=55 && CSRight_B>=20 && CSRight_B<=55&&(LoadedObjects<6))
  {
      Duration = 49;
      CurAction =10;
  }
  ...
  else if(CSLeft_R>=20 && CSLeft_R<=60 && CSLeft_G>=225 && CSLeft_G<=255 && CSLeft_B>=20 && CSLeft_B<=60&&(LoadedObjects<6))
  {
      Duration = 49;
      CurAction =19;
  }
  else if(CSRight_R>=20 && CSRight_R<=60 && CSRight_G>=225 && CSRight_G<=255 && CSRight_B>=20 && CSRight_B<=60&&(LoadedObjects<6))
  {
      Duration = 49;
      CurAction =20;
  }
