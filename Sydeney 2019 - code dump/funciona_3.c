...
//fun Flows._init_values() {
    ...
    _environment_route_point(177, 25, 41);
    _environment_route_point(297, 24, 30);
    _environment_route_point(292, 48, 65);
    _environment_route_point(255, 66, 77);
    _environment_route_point(180, 63, 31);
    _environment_route_point(178, 94, 41);
    ...
    _flowPoint(272, 226, 534, -131);
    _flowPoint(84, 12, 63, 65);
    _flowPoint(78, 20, 33, 107);
