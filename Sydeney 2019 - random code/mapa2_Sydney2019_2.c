...
//fun Flows._init_values() {
    ...
    _environment_route_point(293, 91, 21);
    ...
    _environment_route_point(87, 74, 7);
    _environment_route_point(61, 72, 34);
    ...
    _flowPoint(72, 35, 42, 90);
    _flowPoint(38, 38, 50, 93);
    _flowPoint(44, 41, 33, 71);
    _flowPoint(16, 54, 25, 37);
    _flowPoint(69, 100, 24, -92);
    _flowPoint(65, 100, 19, -90);
    _flowPoint(290, 65, 43, 90);
    _flowPoint(268, 74, 32, 78);
    _flowPoint(278, 78, 15, 67);
    _flowPoint(251, 86, 13, 99);
    _flowPoint(284, 84, 18, 124);
    _flowPoint(207, 262, 33, -90);
    _flowPoint(205, 238, 23, -83);
    _flowPoint(192, 243, 44, -90);
    _flowPoint(186, 230, 23, -90);
    _flowPoint(213, 233, 14, -86);
    _flowPoint(223, 231, 26, -90);
    _flowPoint(200, 222, 1, 0);
    _flowPoint(234, 228, 16, -90);
    _flowPoint(228, 257, 23, -88);
    _flowPoint(195, 169, 39, 89);
    _flowPoint(163, 185, 40, 60);
    _flowPoint(134, 202, 31, 44);
    _flowPoint(242, 194, 25, 127);
    _flowPoint(220, 179, 24, 104);
    _flowPoint(275, 182, 56, 107);
    _flowPoint(255, 174, 36, 104);
    _flowPoint(288, 200, 43, 64);
    _flowPoint(304, 201, 35, 0);
    _flowPoint(307, 177, 33, 3);
    _flowPoint(283, 165, 32, -45);
    _flowPoint(322, 149, 23, 0);
    _flowPoint(318, 113, 18, -49);
    _flowPoint(305, 103, 12, -72);
    _flowPoint(278, 121, 32, -106);
    _flowPoint(261, 131, 29, -110);
    _flowPoint(244, 137, 22, -98);
    _flowPoint(233, 143, 29, -86);
    _flowPoint(232, 140, 22, -128);
    _flowPoint(211, 143, 34, -92);
    _flowPoint(348, 266, 41, -127);
    _flowPoint(313, 261, 17, -90);
    _flowPoint(274, 265, 26, -65);
    _flowPoint(79, 119, 29, -8);
    _flowPoint(88, 133, 19, -55);
    _flowPoint(93, 128, 17, -43);
    _flowPoint(69, 90, 17, -90);
    _flowPoint(74, 99, 26, -65);
    _flowPoint(60, 101, 22, 180);
    _flowPoint(55, 118, 24, 180);
    _flowPoint(57, 92, 23, -144);
    _flowPoint(294, 74, 27, 90);
    _flowPoint(291, 88, 12, 90);
    _flowPoint(283, 91, 23, 133);
    _flowPoint(265, 95, 19, 90);
    _flowPoint(243, 41, 42, -164);
    _flowPoint(220, 36, 26, -176);
    _flowPoint(196, 36, 19, 159);
    _flowPoint(183, 40, 49, 138);
    _flowPoint(216, 59, 24, -99);
    _flowPoint(204, 60, 11, -149);
    _flowPoint(197, 65, 16, -173);
    _flowPoint(204, 65, 31, -96);
    _flowPoint(154, 31, 41, 45);
    _flowPoint(146, 40, 33, 100);
    _flowPoint(275, 54, 41, -156);
    _flowPoint(279, 58, 36, 49);
    _flowPoint(265, 52, 50, 180);
    ...
    _environment_route(false);
    _environment_route_point(30, 206, 5);
    _environment_route_point(37, 187, 31);
    _environment_route_point(37, 151, 22);
    _environment_route_point(37, 112, 22);
    _environment_route_point(44, 80, 22);
    _environment_route_point(63, 67, 18);
    _environment_route_point(91, 81, 28);
    _environment_route_point(120, 80, 25);
    _environment_route_point(148, 82, 20);
    _environment_route_point(149, 108, 27);

    _environment_route(false);
    _environment_route_point(309, 92, 6);
    _environment_route_point(285, 95, 10);
    _environment_route_point(266, 102, 25);
    _environment_route_point(240, 105, 26);
    _environment_route_point(213, 110, 27);
    _environment_route_point(182, 110, 32);
    _environment_route_point(157, 114, 13);
    _environment_route_point(317, 92, 11);

    _environment_route(false);
    _environment_route_point(206, 206, 3);
    _environment_route_point(216, 209, 36);
    _environment_route_point(243, 212, 17);
    _environment_route_point(269, 216, 18);
    _environment_route_point(293, 228, 17);
    _environment_route_point(314, 241, 19);
    _environment_route_point(330, 237, 15);
    _environment_route_point(339, 212, 25);
    _environment_route_point(344, 167, 37);
    _environment_route_point(342, 121, 18);
    _environment_route_point(334, 101, 18);

    _environment_route(false);
    _environment_route_point(146, 230, 23);
    _environment_route_point(128, 235, 25);
    _environment_route_point(104, 242, 16);
    _environment_route_point(79, 245, 21);
    _environment_route_point(52, 245, 19);
    _environment_route_point(33, 233, 14);
    _environment_route_point(29, 218, 8);
...
bool isOrangeRight() {
    return (((CSRight_R > 204 - 10) && (CSRight_R < 235 + 10)) && ((CSRight_G > 130 - 10) && (CSRight_G < 150 + 10)) &&
            ((CSRight_B > 0 - 10) && (CSRight_B < 0 + 10)));
}

bool isOrangeLeft() {
    return (((CSLeft_R > 204 - 10) && (CSLeft_R < 235 + 10)) && ((CSLeft_G > 130 - 10) && (CSLeft_G < 150 + 10)) &&
...
bool shouldCollect() {
  return( LoadedObjects<=4 || (!isFollowingSuperobject && LoadedObjects<6));
}
...
int doStates() {
    ...
    //    if (wantsDeposit() || loadedSuperobject>0) {
