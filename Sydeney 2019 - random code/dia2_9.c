...
//fun Flows._init_values() {
    ...
    _wall(127, 208, 133, 179);
    _wall(133, 179, 160, 181);
    _wall(160, 181, 162, 209);
    _wall(162, 209, 144, 213);
    _wall(144, 213, 126, 208);
    _wall(211, 202, 211, 170);
    _wall(211, 170, 242, 171);
    _wall(242, 171, 242, 201);
    _wall(242, 201, 234, 202);
    _wall(234, 202, 233, 239);
    _wall(233, 239, 240, 239);
    _wall(240, 239, 243, 268);
    _wall(243, 269, 213, 268);
    _wall(213, 268, 211, 242);
    _wall(211, 241, 219, 240);
    _wall(219, 240, 220, 207);
    _wall(220, 207, 211, 203);
    _wall(271, 112, 300, 83);
    _wall(300, 83, 359, 140);
    _wall(359, 140, 356, 81);
    _wall(269, 82, 269, 110);
    _wall(115, 97, 115, 70);
    _wall(115, 70, 146, 69);
    _wall(146, 69, 147, 99);
    _wall(147, 99, 115, 98);
    ...
    _area_group();
    _area(49, 70, 115, 96);
    _area(240, 175, 305, 200);
    _area(305, 175, 351, 260);
    _area(4, 14, 46, 81);
    _area(39, 9, 107, 29);
    _area(122, 212, 204, 262);
    ...
    _environment_route(false);
    _environment_route_point(52, 20, 6);
    _environment_route_point(93, 19, 5);
    _environment_route_point(97, 90, 12);
    _environment_route_point(97, 113, 21);
    _environment_route_point(128, 124, 23);
    _environment_route_point(172, 124, 17);
    _environment_route_point(202, 110, 22);
    _environment_route_point(229, 107, 29);
    _environment_route_point(236, 108, 14);
    _environment_route_point(246, 111, 29);
    _environment_route_point(246, 134, 53);
    _environment_route_point(227, 139, 28);
    _environment_route_point(197, 150, 15);
    _environment_route_point(193, 180, 12);
    _environment_route_point(196, 214, 8);
    _environment_route_point(192, 253, 5);
    _environment_route_point(71, 253, 7);
    _environment_route_point(27, 224, 8);
    _environment_route_point(49, 203, 8);
    _environment_route_point(80, 204, 21);
    _environment_route_point(110, 198, 27);
    _environment_route_point(92, 148, 24);
    _environment_route_point(27, 134, 30);
    _environment_route_point(16, 27, 43);
    ...
    _environment_route(false);
    _environment_route_point(154, 111, 6);

    _environment_route(false);
    _environment_route_point(328, 183, 64);
    _environment_route_point(336, 183, 28);
    _environment_route_point(315, 144, 26);
    _environment_route_point(289, 131, 38);

    _environment_route(false);
    _environment_route_point(319, 243, 12);
    _environment_route_point(304, 247, 14);
    _environment_route_point(281, 241, 17);
    _environment_route_point(265, 223, 56);
    _environment_route_point(264, 175, 16);
    _environment_route_point(257, 146, 12);

    _environment_route(false);
    _environment_route_point(342, 212, 5);
    _environment_route_point(341, 202, 18);

    _flowPoint(154, 32, 12, -90);
    _flowPoint(257, 103, 39, 91);
    _flowPoint(258, 114, 16, 90);
    _flowPoint(275, 113, 13, 86);
    _flowPoint(290, 104, 37, 72);
    _flowPoint(310, 106, 25, 74);
    _flowPoint(336, 123, 29, 90);
    _flowPoint(332, 111, 22, 122);
    _flowPoint(119, 86, 20, 177);
    _flowPoint(146, 85, 25, 16);
    _flowPoint(130, 98, 21, 101);
    _flowPoint(121, 96, 24, 130);
    _flowPoint(152, 96, 31, 107);
    _flowPoint(127, 59, 30, 180);
    _flowPoint(127, 46, 24, -173);
    _flowPoint(118, 24, 17, 180);
    _flowPoint(121, 11, 14, 180);
    _flowPoint(71, 39, 47, -36);
    _flowPoint(58, 38, 27, -94);
    _flowPoint(73, 181, 32, -95);
    _flowPoint(87, 176, 34, 12);
    _flowPoint(81, 169, 19, -90);
    _flowPoint(74, 149, 26, -61);
    _flowPoint(52, 184, 28, -84);
    _flowPoint(30, 165, 26, -61);
    _flowPoint(14, 148, 22, -69);
    _flowPoint(37, 165, 27, -51);
    _flowPoint(20, 150, 24, -45);
    _flowPoint(5, 135, 21, -74);
    _flowPoint(50, 200, 27, 66);
    _flowPoint(65, 198, 35, 65);
    _flowPoint(79, 192, 33, 90);
    _flowPoint(19, 201, 60, 36);
    _flowPoint(17, 233, 39, -21);
    _flowPoint(231, 224, 23, 0);
    _flowPoint(235, 204, 24, 0);
    _flowPoint(210, 213, 20, -160);
    _flowPoint(204, 232, 20, -169);
    _flowPoint(237, 252, 28, 0);
    _flowPoint(284, 233, 57, 139);
    _flowPoint(251, 265, 21, -60);
    _flowPoint(231, 191, 35, 0);
    _flowPoint(231, 180, 19, -90);
    _flowPoint(221, 177, 26, -90);
    _flowPoint(239, 179, 21, -47);
    _flowPoint(108, 206, 55, -87);
    _flowPoint(182, 212, 57, 95);
    _flowPoint(169, 245, 74, 174);
    _flowPoint(237, 204, 29, 0);
    _flowPoint(251, 155, 42, -137);
    _flowPoint(230, 142, 17, -144);
    _flowPoint(217, 137, 18, 180);
    _flowPoint(207, 138, 31, 173);
    _flowPoint(196, 140, 63, 90);
    _flowPoint(181, 119, 31, -15);
    _flowPoint(181, 135, 6, -72);
    _flowPoint(210, 100, 62, 95);
    _flowPoint(194, 95, 8, -117);
    _flowPoint(193, 111, 16, -90);
    _flowPoint(192, 128, 36, -95);
    _flowPoint(204, 135, 42, 114);
    _flowPoint(131, 194, 31, -105);
    _flowPoint(168, 178, 72, 90);
    _flowPoint(143, 169, 27, -114);
    _flowPoint(105, 143, 38, -163);
    _flowPoint(80, 144, 45, 180);
    _flowPoint(103, 117, 59, 26);
    _flowPoint(85, 124, 43, 0);
    _flowPoint(54, 124, 34, -148);
    _flowPoint(35, 131, 22, -129);
    _flowPoint(114, 140, 42, 25);
    _flowPoint(95, 135, 21, 0);
    _flowPoint(92, 150, 37, -151);
    _flowPoint(82, 141, 35, 180);
    _flowPoint(147, 15, 44, 0);
    _flowPoint(142, 28, 27, -13);
    _flowPoint(143, 56, 15, -11);
    _flowPoint(139, 46, 21, 0);
    _flowPoint(146, 77, 14, -48);
    _flowPoint(147, 103, 31, -50);
    _flowPoint(110, 154, 29, -145);
    _flowPoint(113, 151, 21, -177);
    _flowPoint(18, 24, 66, -1);
    _flowPoint(13, 31, 73, -9);
    _flowPoint(296, 157, 24, -63);
    _flowPoint(293, 163, 30, 127);
    _flowPoint(301, 145, 15, -53);
    _flowPoint(302, 167, 17, -54);
    _flowPoint(311, 161, 11, -80);
    _flowPoint(308, 174, 29, 153);
    _flowPoint(312, 150, 9, -103);
    _flowPoint(244, 117, 72, 155);
    _flowPoint(247, 130, 52, 180);
    _flowPoint(226, 115, 25, 127);
    _flowPoint(328, 73, 55, -175);
    _flowPoint(300, 53, 40, -157);
    _flowPoint(298, 27, 73, 178);
    _flowPoint(229, 30, 48, 171);
    _flowPoint(255, 34, 94, 105);
    _flowPoint(227, 35, 71, 104);
    _flowPoint(186, 25, 97, 95);
    _flowPoint(200, 83, 38, 129);
    _flowPoint(286, 82, 34, -144);
    _flowPoint(344, 85, 14, -102);
    _flowPoint(341, 85, 31, -117);
    _flowPoint(323, 81, 31, -135);
    _flowPoint(332, 79, 47, -106);
    _flowPoint(305, 80, 49, -160);
    _flowPoint(306, 75, 30, -120);
    _flowPoint(282, 78, 23, -95);
    _flowPoint(274, 82, 45, -136);
    _flowPoint(269, 86, 29, 178);
    _flowPoint(265, 97, 41, 173);
    _flowPoint(262, 107, 26, 180);
    _flowPoint(189, 73, 38, 105);
    _flowPoint(205, 73, 26, -167);
    _flowPoint(210, 57, 38, 178);
    _flowPoint(223, 65, 23, 0);
    _flowPoint(222, 50, 39, 41);
    _flowPoint(202, 41, 26, 165);
    _flowPoint(230, 76, 32, 39);
    _flowPoint(234, 96, 20, 147);
    _flowPoint(193, 82, 19, 180);
    _flowPoint(188, 93, 43, 55);
    _flowPoint(195, 95, 15, 58);
...
############################
  */
  ...
  else if(CSLeft_R>=200 && CSLeft_R<=250 && CSLeft_G>=122 && CSLeft_G<=160 && CSLeft_B>=0 && CSLeft_B<=15 && CSRight_R>=195 && CSRight_R<=245 && CSRight_G>=120 && CSRight_G<=155 && CSRight_B>=0 && CSRight_B<=15&&(LoadedObjects>0))
  {
      Duration = 59;
      CurAction =2;
  }
  else if(CSLeft_R>=200 && CSLeft_R<=250 && CSLeft_G>=123 && CSLeft_G<=160 && CSLeft_B>=0 && CSLeft_B<=15&&(LoadedObjects>0))
  {
      Duration = 0;
      CurAction =3;
  }
  else if(CSRight_R>=195 && CSRight_R<=245 && CSRight_G>=120 && CSRight_G<=155 && CSRight_B>=0 && CSRight_B<=15&&(LoadedObjects>0))
  {
      Duration = 0;
      CurAction =4;
  }
  else if(CSLeft_R>=200 && CSLeft_R<=245 && CSLeft_G>=205 && CSLeft_G<=255 && CSLeft_B>=0 && CSLeft_B<=10 && CSRight_R>=195 && CSRight_R<=218 && CSRight_G>=205 && CSRight_G<=255 && CSRight_B>=0 && CSRight_B<=10)
  {
      Duration = 0;
      CurAction =5;
  }
  else if(CSLeft_R>=200 && CSLeft_R<=245 && CSLeft_G>=205 && CSLeft_G<=255 && CSLeft_B>=0 && CSLeft_B<=10)
  {
      Duration = 0;
      CurAction =6;
  }
  else if(CSRight_R>=195 && CSRight_R<=218 && CSRight_G>=205 && CSRight_G<=255 && CSRight_B>=0 && CSRight_B<=10)
  {
      Duration = 0;
      CurAction =7;
  }
  else if(CSLeft_R>=230 && CSLeft_R<=255 && CSLeft_G>=20 && CSLeft_G<=50 && CSLeft_B>=20 && CSLeft_B<=50)
  {
      Duration = 49;
      CurAction =8;
  }
  else if(CSRight_R>=215 && CSRight_R<=255 && CSRight_G>=20 && CSRight_G<=45 && CSRight_B>=20 && CSRight_B<=40)
  {
      Duration = 49;
      CurAction =9;
  }
  else if(US_Front>=0 && US_Front<=10 && US_Left>=25 && US_Left<=255 && US_Right>=25 && US_Right<=255)
  {
      Duration = 0;
      CurAction =10;
  }
  else if(US_Front>=0 && US_Front<=14 && US_Left>=0 && US_Left<=18 && US_Right>=0 && US_Right<=18)
  {
      Duration = 1;
      CurAction =11;
  }
  else if(US_Right>=0 && US_Right<=12)
  {
      Duration = 0;
      CurAction =12;
  }
  else if(US_Left>=0 && US_Left<=12)
  {
      Duration = 0;
      CurAction =13;
  }
  else if(US_Front>=0 && US_Front<=12 && US_Left>=0 && US_Left<=15)
  {
      Duration = 1;
      CurAction =14;
  }
  else if(US_Front>=0 && US_Front<=12 && US_Right>=0 && US_Right<=15)
  {
      Duration = 3;
      CurAction =15;
  }
  else if(CSRight_R>=20 && CSRight_R<=50 && CSRight_G>=20 && CSRight_G<=50 && CSRight_B>=20 && CSRight_B<=50)
  {
      Duration = 49;
      CurAction =16;
  }
  else if(CSLeft_R>=22 && CSLeft_R<=50 && CSLeft_G>=22 && CSLeft_G<=50 && CSLeft_B>=22 && CSLeft_B<=50)
  {
      Duration = 49;
      CurAction =17;
  }
  else if(CSLeft_R>=25 && CSLeft_R<=50 && CSLeft_G>=230 && CSLeft_G<=255 && CSLeft_B>=20 && CSLeft_B<=60)
  {
      Duration = 49;
      CurAction =18;
  }
  else if(CSRight_R>=25 && CSRight_R<=60 && CSRight_G>=230 && CSRight_G<=255 && CSRight_B>=20 && CSRight_B<=60)
  {
      Duration = 49;
      CurAction =19;
  }
