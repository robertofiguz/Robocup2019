...
//fun Flows._init_values() {
    ...
    _environment_route_point(286, 219, 8);
    _environment_route_point(290, 194, 5);
    _environment_route_point(292, 181, 7);
    _environment_route_point(287, 166, 8);
    _environment_route_point(290, 151, 8);
    _environment_route_point(283, 127, 21);
