...
//fun Flows._init_values() {
    ...
    _environment_route_point(175, 106, 30);
    ...
    _flowPoint(8, 15, 63, 37);
    _flowPoint(23, 24, 58, 55);
    _flowPoint(25, 45, 69, 73);
    _flowPoint(211, 126, 37, -96);
    _flowPoint(212, 119, 24, -137);
    _flowPoint(144, 130, 29, -90);
    _flowPoint(141, 121, 20, -79);
    _flowPoint(112, 172, 31, 180);
    _flowPoint(109, 182, 28, 168);
    _flowPoint(115, 190, 43, 90);
    _flowPoint(132, 192, 32, 90);
    _flowPoint(110, 168, 30, -161);
    ...
    _flowPoint(227, 140, 36, -68);
    _flowPoint(213, 139, 39, -80);
    _flowPoint(249, 145, 45, -90);
    _flowPoint(239, 177, 52, 0);
    _flowPoint(243, 175, 30, -8);
    _flowPoint(241, 169, 30, -4);
    _flowPoint(253, 169, 32, -90);
    _flowPoint(251, 191, 16, -22);
    _flowPoint(203, 171, 15, 180);
    _flowPoint(234, 126, 24, -76);
    _flowPoint(249, 131, 25, -39);
    _flowPoint(214, 128, 39, -90);
    _flowPoint(284, 185, 76, -101);
    _flowPoint(283, 155, 42, -111);
    _flowPoint(275, 125, 31, -92);
    _flowPoint(298, 230, 42, 142);
    _flowPoint(283, 214, 41, 150);
    ...
    _environment_route(false);
    _environment_route_point(69, 249, 17);
    _environment_route_point(121, 256, 23);
    _environment_route_point(160, 255, 32);
    _environment_route_point(175, 235, 55);

    _environment_route(false);
    _environment_route_point(173, 221, 6);
    _environment_route_point(185, 199, 12);
    _environment_route_point(167, 178, 9);
    _environment_route_point(185, 162, 14);
    _environment_route_point(168, 139, 17);
    _environment_route_point(188, 120, 15);
    _environment_route_point(163, 95, 21);
    _environment_route_point(68, 99, 15);
    _environment_route_point(33, 111, 11);
    _environment_route_point(24, 168, 75);
    _environment_route_point(30, 211, 26);
    _environment_route_point(55, 241, 49);

    _flowPoint(146, 187, 28, -32);
    _flowPoint(144, 198, 30, 15);
    _flowPoint(150, 171, 15, 0);
    _flowPoint(148, 158, 15, -8);
    _flowPoint(149, 148, 16, 0);
    _flowPoint(148, 142, 19, -55);
    _flowPoint(146, 131, 22, 0);
    _flowPoint(206, 189, 21, 180);
    _flowPoint(206, 177, 16, -169);
    _flowPoint(210, 164, 15, -130);
    _flowPoint(208, 155, 27, -176);
    _flowPoint(210, 137, 10, -127);
    _flowPoint(207, 190, 22, 98);
    _flowPoint(230, 195, 22, 144);
    _flowPoint(243, 197, 28, 117);
    _flowPoint(212, 203, 21, 158);
    _flowPoint(108, 191, 35, 88);
    _flowPoint(127, 193, 44, 90);
    _flowPoint(104, 177, 38, 154);
    _flowPoint(103, 166, 53, 144);
    _flowPoint(107, 137, 51, 171);
    _flowPoint(220, 116, 34, 180);
    _flowPoint(200, 116, 15, -169);
    _flowPoint(159, 74, 38, 107);
    _flowPoint(169, 89, 19, 150);
    _flowPoint(101, 75, 32, 142);
    _flowPoint(278, 198, 82, 134);
    _flowPoint(293, 214, 47, 90);
    _flowPoint(326, 208, 78, 109);
    _flowPoint(225, 148, 56, -82);
    _flowPoint(238, 174, 89, -63);
    _flowPoint(278, 153, 88, -83);
    _flowPoint(329, 151, 105, -132);
    _flowPoint(311, 110, 98, -163);
    _flowPoint(268, 103, 58, -166);
    _flowPoint(228, 141, 44, -90);
    _flowPoint(237, 132, 22, -72);
    _flowPoint(241, 135, 32, -117);
    _flowPoint(234, 94, 42, 180);
    _flowPoint(210, 102, 34, 180);
    _flowPoint(311, 240, 48, 150);
    _flowPoint(289, 233, 67, 160);
    _flowPoint(250, 227, 76, 165);
    _flowPoint(231, 232, 50, 179);
    _flowPoint(222, 232, 55, 180);
    _flowPoint(207, 218, 43, 180);
    _flowPoint(191, 230, 19, 180);
    _flowPoint(248, 250, 80, -166);
    _flowPoint(224, 257, 53, -179);
    _flowPoint(217, 127, 26, -90);
    _flowPoint(213, 127, 37, -92);
...
bool shouldDeposit() {
    return (LoadedObjects > 2 || loadedSuperobject>=1);
}
...
int doStates() {
    ...
    if (canCollect() && shouldCollect() ) {
        ...
        if (wantsDeposit() || loadedSuperobject>0 ||(loadedColor[0]>0&&loadedColor[2]>0&&loadedColor[1]>0)) { //possible add if RGB is loaded go to deposit by: Roberto Figueiredo 28 june 2019 18:17
...
void switchEnvIfNeeded() {
    ...
    if(loadedColor[0]>0&&loadedColor[2]>0&&loadedColor[1]==0){
      ...
      setBottomEnv(3);//why won't it work? By: Roberto figueiredo 28 june 2019 21:27
...
############################
  */
      ...
      else if(US_Front>=0 && US_Front<=13 && US_Left>=20 && US_Left<=255 && US_Right>=20 && US_Right<=255)
      {
          Duration = 0;
          CurAction =10;
      }
      else if(US_Front>=0 && US_Front<=11 && US_Left>=0 && US_Left<=13 && US_Right>=0 && US_Right<=13)
      {
          Duration = 3;
          CurAction =11;
      }
      else if(US_Right>=0 && US_Right<=14)
      {
          Duration = 0;
          CurAction =12;
      }
      else if(US_Left>=0 && US_Left<=14)
      {
          Duration = 0;
          CurAction =13;
      }
      else if(US_Front>=0 && US_Front<=13 && US_Left>=0 && US_Left<=15)
      {
          Duration = 1;
          CurAction =14;
      }
