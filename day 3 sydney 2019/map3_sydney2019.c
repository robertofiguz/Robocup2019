...
//fun Flows._init_values() {
    ...
    _environment_route(false);
    _environment_route_point(84, 237, 9);
    _environment_route_point(115, 231, 21);
    _environment_route_point(148, 227, 20);
    _environment_route_point(171, 207, 17);
    _environment_route_point(178, 167, 42);
    _environment_route_point(174, 121, 26);
    _environment_route_point(157, 100, 44);
    _environment_route_point(128, 108, 43);
    _environment_route_point(115, 126, 19);

    _environment_route(false);

    _flowPoint(84, 238, 83, -8);
    _flowPoint(149, 138, 18, 13);
    _flowPoint(149, 163, 23, -15);
    _flowPoint(158, 191, 20, 0);
    _flowPoint(124, 202, 50, 60);
    _flowPoint(147, 198, 22, 63);
    _flowPoint(106, 181, 27, 180);
    _flowPoint(94, 131, 23, 5);
    _flowPoint(84, 141, 51, 15);
    _flowPoint(105, 111, 52, 50);
    _flowPoint(113, 136, 29, 48);
    _flowPoint(138, 149, 16, 180);
    _flowPoint(139, 133, 13, 180);
    _flowPoint(131, 117, 24, 104);
    _flowPoint(307, 249, 55, 180);
    _flowPoint(286, 216, 29, 96);
    _flowPoint(261, 224, 16, 107);
    _flowPoint(220, 217, 34, 116);
    _flowPoint(217, 210, 28, 180);
    _flowPoint(241, 222, 43, 90);
    _flowPoint(284, 225, 32, 112);
    _flowPoint(313, 224, 42, 144);
    _flowPoint(334, 224, 27, 96);
    _flowPoint(213, 193, 41, 165);
    _flowPoint(208, 181, 21, -167);
    _flowPoint(210, 158, 17, -159);
    _flowPoint(208, 143, 24, -161);
    _flowPoint(207, 132, 13, 180);
    _flowPoint(268, 187, 19, -96);
    _flowPoint(267, 174, 15, -90);
    _flowPoint(267, 161, 25, -90);
    _flowPoint(267, 145, 26, -97);
    _flowPoint(265, 132, 37, 180);
    _flowPoint(240, 133, 19, 180);
    _flowPoint(236, 135, 12, 180);
    _flowPoint(225, 124, 34, 90);
    _flowPoint(231, 140, 17, 97);
    _flowPoint(215, 154, 9, 0);
    _flowPoint(215, 145, 12, -18);
    _flowPoint(213, 137, 13, -42);
    _flowPoint(227, 121, 14, -98);
    _flowPoint(216, 120, 22, -170);
    _flowPoint(221, 121, 17, -130);
    _flowPoint(212, 129, 20, -90);
    _flowPoint(216, 128, 22, -85);
    _flowPoint(207, 124, 14, -115);
    _flowPoint(192, 105, 37, 161);
    _flowPoint(197, 82, 33, 100);
    _flowPoint(175, 88, 21, 90);
    _flowPoint(140, 82, 36, 90);
    _flowPoint(75, 191, 38, -84);
    _flowPoint(62, 172, 39, -54);
